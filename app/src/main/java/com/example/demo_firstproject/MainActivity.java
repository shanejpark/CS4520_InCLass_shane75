...
public class MainActivity extends AppCompatActivity {
    private Button practice, InClass01, InClass02, InClass03, InClass04, InClass05, InClass06, InClass07;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InClass07 = findViewById(R.id.hw7);
        InClass07.setOnClickListener(v ->
                startActivity(new Intent(MainActivity.this, com.example.demo_firstproject.inClass07.InClass07.class)));
    }
}